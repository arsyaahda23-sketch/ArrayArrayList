...
public class Perpustakaan {
    ...
    public void pinjamBuku(String judul) {
        for (Buku b : koleksi) {
            if (b.getJudul().equalsIgnoreCase(judul)) { // Menggunakan equalsIgnoreCase agar tidak sensitif huruf besar/kecil
                if (b.isDipinjam()) {
    ...
    /**
     * METHOD BARU: Mengubah status sebuah buku menjadi tidak dipinjam (tersedia kembali)
     */
        ...
        for (Buku b : koleksi) {
            if (b.getJudul().equalsIgnoreCase(judul)) {
                if (!b.isDipinjam()) {
                    ...
                    b.setDipinjam(false); // Mengubah status menjadi false (tersedia)
                    System.out.println(judul + " berhasil dikembalikan.");
                }
                return; // Keluar dari method setelah buku ditemukan
            }
        }
        System.out.println("Buku " + judul + " tidak ditemukan.");
    }
